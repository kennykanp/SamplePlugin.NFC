...
namespace Plugin.NFC.Droid
{
	...
	public static partial class CrossNFC
	{
		...
		public static void OnNewIntent(Intent intent) => NFCImplementation.Current.HandleNewIntent(intent); // TODO: Find another way for this

		/// <summary>
		/// Overrides Activity.OnResume()
		/// </summary>
		public static void OnResume() => NFCImplementation.Current.HandleOnResume(); // TODO: Find another way for this
